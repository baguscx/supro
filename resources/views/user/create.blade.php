                            ...
                            <div class="row mt-2 gy-4">
                                <div class="col-md-12">
                                    ...
                                    <div class="mt-3 form-floating form-floating-outline">
                                        <x-ui.text-input id="judul_inovasi" name="judul_inovasi" type="text" placeholder="Judul Inovasi"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline">
                                        <x-ui.text-input id="target_sdgs" name="target_sdgs" type="text" placeholder="Target SDGs"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline">
                                        <x-ui.text-input id="video_inovasi" name="video_inovasi" type="text" placeholder="youtu.be/abcdefg"/>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <x-ui.text-input id="sp_inovator" name="sp_inovator" type="file"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <x-ui.text-input id="sp_replikasi" name="sp_replikasi" type="file"/>
                                    </div>
                                </div>
                            </div>
